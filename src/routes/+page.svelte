...
<footer class="border-t border-slate-100 bg-white px-4 py-12 sm:px-6 lg:px-8">
	<div class="mx-auto max-w-7xl">
		<div class="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-4">
			...
			<div class="space-y-4">
				...
				<ul class="space-y-2 text-sm text-slate-600">
					<li>
						<a href="/layanan/custom-development" class="hover:text-[#0155FF]">Pengembangan Software Kustom</a>
					</li>
					<li>
						<a href="/layanan/enterprise-erp" class="hover:text-[#0155FF]">Sistem ERP & Integrasi Bisnis</a>
					</li>
					<li>
						<a href="/layanan/hris-payroll" class="hover:text-[#0155FF]">HRIS & Otomatisasi Payroll</a>
					</li>
					<li>
						<a href="/layanan/simrs-simklinik" class="hover:text-[#0155FF]">SIMRS & SIM Klinik</a>
					</li>
					<li>
						<a href="/layanan/pos-inventory" class="hover:text-[#0155FF]">POS & Manajemen Inventaris</a>
					</li>
				</ul>
			</div>
			...
			<div class="space-y-4">
				...
				<div class="pt-2">
					<p class="mb-2 text-xs font-medium text-slate-400">Ikuti Kami:</p>
					<div class="flex items-center gap-2">
						<!-- WhatsApp -->
						<a
							href={whatsappLink}
						...
						>
							<svg viewBox="0 0 24 24" class="h-4.5 w-4.5 fill-current" xmlns="http://www.w3.org/2000/svg">
			...
			<!-- Local SEO Google Maps Widget -->
			<div class="space-y-3">
				<h4 class="text-xs font-semibold tracking-wider text-slate-400 uppercase">
					Lokasi Operasional
				</h4>
				<div class="overflow-hidden rounded-2xl border border-slate-200 bg-slate-50 p-1 shadow-sm">
					<iframe
						title="Peta Lokasi PT AORTA DIGITAL SOLUSI"
					<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3961.7233288867883!2d107.20039257501804!3d-6.803473516541446!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e685498f7ac0f07%3A0x79270397afb309c6!2sPerumahan%20Protanmas%20Samolo%20Indah!5e0!3m2!1sid!2sid!4v1790232138833!5m2!1sid!2sid"
						width="100%"
						height="150"
						style="border:0;"
						allowfullscreen=""
				...
				<p class="text-[11px] font-medium text-slate-400">
					*Melayani proyek software kustom seluruh Indonesia.
				</p>
			</div>
		</div>
