...
<section class="bg-white px-4 py-20 sm:px-6 lg:px-8">
	<div class="mx-auto max-w-7xl">
		...
		<div class="mb-12 max-w-2xl">
			...
			<p class="mt-3 text-base text-slate-600">Apa kata mitra yang telah mempercayakan pengembangan sistem kustomnya kepada</p>  <span class="text-[#0155FF] font-bold">Aorta Digital Solusi</span>
		</div>
		...
		>
			...
			<div class="mb-5 flex justify-center">
				<span class="inline-flex items-center gap-1.5 rounded-full bg-[#1E293B] px-5 py-1.5 text-xs font-bold tracking-wider uppercase text-white shadow-md">
					E-LEARNING &amp; LMS
				</span>
			</div>
			...
			<div class="text-center">
				<h3 class="text-xl font-bold tracking-tight text-slate-900">
					Kaigopedia (LMS Platform)
				</h3>

				<blockquote class="mt-4 text-xs leading-relaxed text-slate-600 sm:text-base">
					“Tim AORTA membangun LMS Kaigopedia sesuai harapan dan kebutuhan kami, responsif dan tepat waktu. Suka banget sama hasilnya!”
				</blockquote>
			...
			{#each faqs as faq, i}
				...
				>
					...
					>
						...
						<ChevronDown
							size={16}
							class="shrink-0 text-slate-400 transition-transform duration-200 {faqOpen === i ? 'rotate-180' : ''}"
						/>
					</button>
					{#if faqOpen === i}
						<div
	...
	>
		...
		<div class="relative z-10 mx-auto max-w-2xl text-center">
			...
			<p class="mt-4 text-base text-slate-200">
				Mulai eksplorasi platform kami atau diskusikan kebutuhan sistem Anda bersama tim sales ahli kami.
			</p>
...
<footer class="border-t border-slate-100 px-4 py-12 sm:px-6 lg:px-8">
	<div class="mx-auto max-w-7xl">
		<div class="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-4">
			<div class="space-y-4">
				<div class="flex items-center gap-2">
					<picture>
						...
						<img src="/assets/logo.png" alt="AORTA" class="h-8 w-8 rounded" width="32" height="32" />
					</picture>
					<span class="text-lg font-bold text-slate-900">PT AORTA DIGITAL SOLUSI</span>
				</div>
				<p class="text-sm leading-relaxed text-slate-500">
					Mitra transformasi digital dan pengembang software kustom untuk efisiensi operasional bisnis di Indonesia.
				</p>
				<!-- <a
					href="/tentang-kami"
			...
			<div class="space-y-4">
				<h4 class="text-xs font-semibold tracking-wider text-slate-400 uppercase">Solusi & Layanan</h4>
				<ul class="space-y-2 text-sm text-slate-600">
					<li><a href="/layanan/custom-development" class="hover:text-[#0155FF]">Pengembangan Software Kustom</a></li>
					<li><a href="/layanan/enterprise-erp" class="hover:text-[#0155FF]">Sistem ERP &amp; Integrasi Bisnis</a></li>
					<li><a href="/layanan/hris-payroll" class="hover:text-[#0155FF]">HRIS &amp; Otomatisasi Payroll</a></li>
					<li><a href="/layanan/simrs-simklinik" class="hover:text-[#0155FF]">SIMRS &amp; SIM Klinik</a></li>
					<li><a href="/layanan/pos-inventory" class="hover:text-[#0155FF]">POS &amp; Manajemen Inventaris</a></li>
				</ul>
			</div>
