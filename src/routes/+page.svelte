<script>
	...
	import bgMain from '$lib/assets/bg_main3.webp';
	import bgKaigopedia from '$lib/assets/kaigopedia.webp';
	import {
		MessageSquare,
		Mail,
		Phone,
			...
			<div class="space-y-3">
				...
				<div class="overflow-hidden rounded-2xl border border-slate-200 bg-slate-50 p-1 shadow-sm">
					<iframe
						...
						src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3961.7233288867883!2d107.20039257501804!3d-6.803473516541446!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e685498f7ac0f07%3A0x79270397afb309c6!2sPerumahan%20Protanmas%20Samolo%20Indah!5e0!3m2!1sid!2sid!4v1790232138833!5m2!1sid!2sid"
						width="100%"
						height="150"
						style="border:0;"
						allowfullscreen=""
