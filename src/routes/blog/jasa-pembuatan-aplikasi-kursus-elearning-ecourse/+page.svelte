...
<ArticleLayout
	...
	readTime="6 menit"
>
	<h2>Fitur E-Learning yang Wajib Ada</h2>

	<p>
		Banyak lembaga kursus ingin punya platform belajar online sendiri, tapi bingung mulai dari mana.
		Sebelum membangun atau memilih vendor, pastikan platform Anda punya fitur-fitur berikut ini.
	</p>

	<h2>Checklist Fitur Wajib</h2>

	<h3>1. Manajemen Kursus &amp; Kelas</h3>
	<p>
		Platform harus bisa membuat kelas dengan jadwal, batch, dan tipe (online/offline/hybrid). Tanpa
		this, susah mengelola banyak kursus sekaligus. Fitur ini jadi fondasi — setiap fitur lain
		menggunakan data kelas.
	</p>
	...
	<p>
		Setidaknya ada 3 role: admin (kelola platform), instruktur (kelola materi &amp; nilai), dan
		siswa (akses materi &amp; quiz). Tanpa role-based access, semua orang bisa akses semua data.
	</p>

	<h3>6. Pembayaran &amp; Pendaftaran</h3>
	<p>
		Siswa harus bisa daftar dan bayar langsung dari platform. Integrasi payment gateway (QRIS,
		transfer, kartu kredit) dan konfirmasi otomatis mengurangi dropout di tahap pendaftaran.
	</p>
	...
	<table>
		...
		<tbody>
			...
			<tr><td>Biaya</td><td>Potongan komisi 20-50%</td><td>Tanpa potongan</td></tr>
			<tr><td>Fitur</td><td>Terbatas yang disediakan</td><td>Sesuai kebutuhan</td></tr>
			<tr><td>Kontrol Harga</td><td>Bisa ditentukan marketplace</td><td>Anda yang tentukan</td></tr>
		</tbody>
	</table>
	...
	<h2>Kapan Harus Bangun Sendiri?</h2>
	<ul>
		<li>Lembaga kursus dengan 100+ siswa aktif — marketplace sudah tidak efisien</li>
		<li>Ingin membangun brand kuat — nama sendiri, bukan nama marketplace</li>
		<li>Butuh fitur khusus ( integrasi SPP, manajemen kelas offline, dll)</li>
		<li>Data murid sensitif — tidak boleh diakses pihak ketiga</li>
	</ul>

	<h2>Kesimpulan</h2>
	<p>
		Platform e-learning yang baik bukan cuma tempat upload video — tapi sistem lengkap yang
		mengelola siswa, materi, penilaian, dan pembayaran. Pastikan fitur wajib di atas ada sebelum
		memutuskan vendor atau teknologi.
	</p>
